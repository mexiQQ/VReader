...
public class NewsLatestTextActivity extends Activity
{
	DBHelperB helper = null;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        helper = new DBHelperB(getApplicationContext());
		...
		Cursor c = db.query("vreader", new String[]{"content"}, "title=?", new String[]{title}, null, null, null);
		if (c.moveToNext()) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {  
        ...
        case R.id.menu_add:
        	// 是否只有已登录用户才能打开分享选择页
            mController.openShare(NewsLatestTextActivity.this, false);
        	break;
