 ...
 * 新闻列表Activity
 */
public class NewsModuleActivity extends Activity implements OnItemSelectedListener,
		OnItemClickListener {
	ListView listView;
	...
	public void getInfoFromCache(final int bankuai) {
		...
		Cursor c = db.query("Out", null, "news_type="+bankuai, null, null, null, null);
		if (c.getCount() > 0) {
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		 Intent it = new Intent(NewsModuleActivity.this, NewsModuleTextActivity.class);
